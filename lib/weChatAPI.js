...
exports.postMenu = function (accessToken, menuFilePath, cb) {

    var fs = require('fs');
    const filePath = '../public/customer_menu.json';
...
exports.fetchUserInfo = function (accessToken,openid,lang,cb) {
    var options = {
        host: 'api.weixin.qq.com',
